...
const ERROR_SYNAPSE int = 100000
...
// Synapse
const WARNING_SYNAPSE_NOT_FOUND int = WARNING + ERROR_SYNAPSE + ERROR_NOT_FOUND
const WARNING_SYNAPSE_NOT_SET int = WARNING + ERROR_SYNAPSE + ERROR_NOT_SET
const ERROR_SYNAPSE_READ int = ERROR + ERROR_SYNAPSE + ERROR_READ
const ERROR_FATAL_SYNAPSE_INVALID_DATA int = ERROR_FATAL + ERROR_SYNAPSE + ERROR_INVALID_DATA
const ERROR_FATAL_SYNAPSE_CREATE int = ERROR_FATAL + ERROR_SYNAPSE + ERROR_CREATE
...
var errorString = map[int]string{
	...
	// Synapse
	WARNING_SYNAPSE_NOT_FOUND:        "The synapse ID '%d' is not found.",
	ERROR_SYNAPSE_READ:               "Cannot read the synapse. this synapse is dead",
	ERROR_FATAL_SYNAPSE_INVALID_DATA: "The synapse data is invalid.",
	ERROR_FATAL_SYNAPSE_CREATE:       "Cannot create the synapse.",
